...
/**
 * Created by anuragsinha on 16-05-23.
 */
public class MainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        final MainAdapterViewHolder holder = (MainAdapterViewHolder) viewHolder;
        bindDefaultFeedItem(position, holder);
    }

    private void bindDefaultFeedItem(int position, MainAdapterViewHolder holder) {
        if (position % 2 == 0) {
